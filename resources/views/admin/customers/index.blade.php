                                        ...
                                        @isset($customers)
                                            @foreach($customers as $customer)
                                                <tr>
                                                    ...
                                                    <td>{{$customer -> name}}</td>
                                                    <td><img style="width: 150px; height: 100px;" src="{{$customer->logo}}"></td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <a href="{{route('admin.customers.delete',$customer -> id)}}"
                                                               ...
                                                               <a href="{{route('admin.order.create', $customer -> id)}}"
                                                               class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">اضف طلب</a>
