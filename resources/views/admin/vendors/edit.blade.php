                                    ...
                                    <form class="form" action="{{route('admin.vendors.update',$vendor->id)}}"
                                        ...
                                        <div class="form-group">
                                          <div class="text-center">
                                             <img src="{{$vendor->logo}}"
                                                  class="rounded-circle height-150" alt="صورة التاجر" >
                                          </div>
                                        </div> 
                                                               ...
                                                               <select name='category_id' id="category_id" class="select2 form-control">
                                                                 ...
                                                                 <option> من فضلك أختر القسم </option>
                                                                  @foreach($categories as $category)
                                                                   <option value=" {{$category->id}}" {{$category->id == $vendor->category_id ? 'selected' : '' }} id="maincat">{{$category->name}}</option>
                                                                  @endforeach
                                                                 @endisset   
                                                               </select>
                                                                @error("category_id")
                                                         ...
                                                         <div class="col-md-6 ">
                                                            <div class="form-group">
                                                               ...
                                                               <select name='subcat' id="subcat" class="select2 form-control">
                                                                 @isset($subcategories)
                                                                 <option {{$subcat == $vendor->subcat ? 'selected' : ''}}> من فضلك أختر القسم الفرعي</option>
...
function initAutocomplete() {
    var latmap = $("#latitude").val(),
        lngmap = $("#longitude").val();
    var pos = {
               lat: '{{ $vendor->latitude }}' ,  
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs&callback=initMap&libraries=places&callback=initAutocomplete&language=ar&region=EG
 async defer"></script>
@stop
