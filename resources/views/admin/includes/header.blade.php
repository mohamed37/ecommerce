                ...
                <span class="mr-1">مرجبا
                  ...
                  <img  style="height: 35px;" src="" alt="avatar"><i></i></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href=""><i
                            ...
                            <a class="dropdown-item" href="{{route('admin.sginout')}}"><i class="ft-power"></i> تسجيل
                                الخروج </a>
                               
                        </div>
                    </li>

                    <li class="dropdown dropdown-notification dropdown-notifications nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                ...
                                <span class="notification-tag badge badge-default badge-danger float-right m-0"> 
                                    عدد الاشعارات الغير مقرءه : {{ auth()->user()->unreadNotifications->count() }}
                                </span>
                            </li>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="javascript:void(0)">قراءة كل الاشعارات</a>
                            </li>
                        </ul>
                    </li>
