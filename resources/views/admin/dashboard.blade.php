                                ...
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>الأقسام</h4>
                                            <h6 class="text-muted">الاقسام الرئيسية</h6>
                                        </div>

                                        <div class="col-5 text-right">
                                            <h4>{{App\Models\MainCategory::active()->count()}} النشط</h4>
                                            <h6 class="success darken-4">{{App\Models\MainCategory::count()}} <i class="la la-arrow-up"></i></h6>
                                        </div>
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>التجار</h4>
                                            <h6 class="text-muted">التجار</h6>
                                        </div>
                                        <div class="col-5 text-right">
                                            <h4>{{App\Models\Vendor::active()->count()}} Active</h4>
                                            <h6 class="success darken-4">{{App\Models\Vendor::count()}} <i class="la la-arrow-up"></i></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-right">
                                            <h4>{{App\Models\Products::active()->count()}} active</h4>
                                            <h6 class="danger">{{App\Models\Products::count()}} <i class="la la-arrow-down"></i></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
